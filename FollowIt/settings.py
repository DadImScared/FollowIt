"""
Django settings for FollowIt project.
...
ALLOWED_HOSTS = ['followit.pythonanywhere.com', '127.0.0.1']
...
WSGI_APPLICATION = 'FollowIt.wsgi.application'
